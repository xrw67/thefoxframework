#ifndef _THEFOX_NET_BUFFER_H
#define _THEFOX_NET_BUFFER_H
...
{
public:
	static const size_t kCheapPrepend = 8; // 开头预留的字节数
	static const size_t kInitialSize = 1024; // 初始化的字节数
	...
	void retrieve(size_t len)
	{
		...
		{
			_readerIndex += len; //? _readerIndex -= len;
		}
		else
		{
			retrieveAll();
